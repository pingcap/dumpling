...
// SelectFromSQL dumps data from a SQL
...
func buildSelectField(db *sql.Conn, dbName, tableName string, completeInsert bool) (string, error) { // revive:disable-line:flag-parameter
