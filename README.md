...
You may read the [design document](https://github.com/pingcap/community/blob/master/rfc/2019-12-06-dumpling.md) and [Chinese Document](docs/cn/user-guide.md) for details.
